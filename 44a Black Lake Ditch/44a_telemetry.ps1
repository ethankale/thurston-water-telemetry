...
foreach ($file in $FilesToDownload) {
    ...
    # We have a TidBit deployed at 44a; we don't want to insert temperature,
    #  but we do want to have it archived in case of instrument failure.
...
if ($MinDate.Length -eq 0) {
    ...
    $tables = 'tblDischargeDaily', 'tblBarometerDaily'
